...
map("t", "<leader>th", [[<C-\><C-n><cmd>1ToggleTerm direction=horizontal<CR>]], opt)
map("t", "<leader>tv", [[<C-\><C-n><cmd>1ToggleTerm direction=vertical<CR>]], opt)
map("t", "<leader>tc", [[<C-\><C-n><cmd>1ToggleTerm direction=float<CR>]], opt)
-- 左右比例控制
...
map("n", "<leader>th", [[<cmd>1ToggleTerm direction=horizontal<CR>]], opt)
map("n", "<leader>tv", [[<cmd>1ToggleTerm direction=vertical<CR>]], opt)
map("n", "<leader>tc", [[<cmd>1ToggleTerm direction=float<CR>]], opt)   -- 浮动窗口模式 (center)
map("i", "<leader>th", [[<ESC><cmd>1ToggleTerm direction=horizontal<CR>]], opt)
map("i", "<leader>tv", [[<ESC><cmd>1ToggleTerm direction=vertical<CR>]], opt)
map("i", "<leader>tc", [[<ESC><cmd>1ToggleTerm direction=float<CR>]], opt)
-- Copilot
